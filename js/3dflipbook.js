! function(modules) {
    ...
    var Pdf = function() {
        function Pdf(src, loadingProgress) {
            ...
            //     xhr.send();
            // };
            // getDataUri(this.src, function (base64) {
    ...
    var _extends = Object.assign || function(target) {
        ...
        Book = function(_THREE$EventDispatche) {
            function Book(visual, sheets, pageCallback, props) {
                ...
                }), 0, sheets, 0, "closed")), _this.set(Math.PI / 2), _this.openedBox = (new _libs.THREE.Box3).setFromObject(_this.leftCover.three), _this.openedBox.union((new _libs.THREE.Box3).setFromObject(_this.rightCover.three)), _this.angle = _this.p.rtl ? Math.PI : 0, _this.closedAngle = 0, _this.set(_this.angle, 0), _this.lastMousePos = {
                    t: 0
                    ...
                    touchCmdSwipe: {
                        activate: function(e, data) {
                            if (isSwipping("touchCmdSwipe"))
                                ...
                                } else "move" === data.state ? (e.preventDefault(), _this8.swipeData.handled || (_this8.swipeData = _extends({}, _this8.swipeData, {
    ...
    var _extends = Object.assign || function(target) {
        ...
        Object3DWatcher = function() {
            ...
            return Object3DWatcher.prototype.setPadding = function(padding) {
                ...
                else dv.set(this.computeCorr(Kx, box.min.x, box.max.x), this.computeCorr(Ky, box.min.y, box.max.y));
    ...
    var _extends = Object.assign || function(target) {
        ...
        View = function() {
            function View(parentContainer, onLoad) {
                ...
                }, this.parentContainer = (0, _libs.$)(parentContainer), this.isIOS = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream, this.isSafari = /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && ~navigator.userAgent.search("Version/14.1");
